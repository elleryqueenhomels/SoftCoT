...
log_file_name="${log_dir}/New-Baseline-AIME2024-${base_model_name}-tokens${num_thought_tokens}-seed${seed}.log"
...
log_file_name="${log_dir}/New-Baseline-AIME2025-${base_model_name}-tokens${num_thought_tokens}-seed${seed}.log"
...
log_file_name="${log_dir}/New-Baseline-MATH500-${base_model_name}-tokens${num_thought_tokens}-seed${seed}.log"
...
log_file_name="${log_dir}/New-Baseline-ASDivAug-${base_model_name}-tokens${num_thought_tokens}-seed${seed}.log"

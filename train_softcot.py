...
base_tokenizer = AutoTokenizer.from_pretrained(large_model_id, token=os.environ['HUGGING_FACE_TOKEN'])
assistant_tokenizer = AutoTokenizer.from_pretrained(small_model_id, token=os.environ['HUGGING_FACE_TOKEN'])
